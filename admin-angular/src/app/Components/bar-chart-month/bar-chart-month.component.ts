...
export class BarChartMonthComponent  implements OnInit{
  ...
  getAllUsers() {
    this.client.get<User>("http://localhost:8000/api/user/statstic/2023-04-5/2023-05-5").subscribe(value => {     // console.log(value);
    this.data[0]["Likes"]=value.count.toString()+0;
  ...
  getAlltweeta() {
    this.client.get<User>("http://localhost:8000/api/tweet/statstic/2023-04-5/2023-05-5").subscribe(value => {
      this.data[1]["Likes"]=value.count.toString()+0;
      // console.log(value.count+0);
