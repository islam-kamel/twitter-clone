                        ...
                        <div className="tab-pane fade show active" id="nav-All" role="tabpanel" aria-labelledby="nav-All-tab" tabIndex="0">
                            <div className="mx- px-4">
                                ...
                                <div className="img-Notifications h-100 position-relative border-bottom  ">
                                    <div className=" my-4">
                                        <div className="d-flex w-25 align-items-center justify-content-start pt-2 mb-3 ms-2">
                                            <i className="fa-solid fa-star fa-1x me-2"></i>
                                            <img  className="" src={Avatare} alt=""/>
                                        </div>
                                        <p className="text-muted ms-5  mb-5">Osama Elzero Liked Your reply </p>
                                        <p className="pe-3 position-absolute bottom-0 end-0"> <span><i className="fa-solid fa-heart"></i></span> اخويا متولي ده راجل ملهوش حل</p>
                                    </div>
                                </div>
                                <div className="img-Notifications h-100 position-relative border-bottom  ">
                                    <div className=" my-4">
                                        ...
                                        <p className="text-muted ms-5  mb-5">Osama Elzero Liked Your reply </p>
                                        <p className="pe-lg-3 ps-md-0 position-absolute bottom-0 end-0"> <span><i className="fa-solid fa-heart"></i></span> اخويا صبحي ده راجل ملهوش حل</p>
                                    </div>
                                </div>
                                <div className="img-Notifications h-100 position-relative border-bottom  ">
                                    <div className=" my-4">
                                        ...
                                        <p className="text-muted ms-5  mb-5">Osama Elzero Liked Your reply </p>
                                        <p className="pe-3 position-absolute bottom-0 end-0"> <span><i className="fa-solid fa-heart"></i></span> اخويا محمد ده راجل ملهوش حل</p>
                                    </div>
                                </div>
                                <div className="img-Notifications h-100 position-relative border-bottom  ">
                                    <div className=" my-4">
                                        ...
                                        <p className="text-muted ms-5  mb-5">Osama Elzero Liked Your reply </p>
                                        <p className="pe-3 pe-sm-0 position-absolute bottom-0 end-0"> <span><i className="fa-solid fa-heart"></i></span> اخويا احمد ده راجل ملهوش حل</p>
                                    </div>
                                </div>
                            </div>
                        </div>
{/* <!-- ======================================== verified =================================================== --> */}
                        ...
                        <div className="tab-pane fade" id="nav-Verified" role="tabpanel" aria-labelledby="nav-Verified-tab" tabIndex="0">
                            <div className=" verified mx-5 px-4">
                                ...
                                <p className="text-muted">Likes, mentions, Retweets, and a whole lot more — when it comes from a verified account, you’ll find it here. <span><a className="text-black" href="https://help.twitter.com/en/managing-your-account/about-twitter-verified-accounts">Learn more</a></span></p>
                            </div>
                        </div>
