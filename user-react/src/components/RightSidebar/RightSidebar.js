      ...
      <aside className="w-100 h-100">
        ...
        <div className="p-0 mt-3 ms-3 h-100 overflow-scroll">
          <div className="maindiv bg-element">
            <h1 style={{fontSize: "20px", fontWeight: "700", padding: "13px 12px", margin: "0"}}>{t("rightsidebar.what_happening")}</h1>
            <Cardtrandy trindname={t("explore.foru_placeName")} trindy={t("rightsidebar.trendy")} tweetnumber="100000k" tweets={t("profile.tweets")}/>
            <Cardtrandy trindname={t("explore.foru_placeName")} trindy={t("rightsidebar.trendy")} tweetnumber="100000k" tweets={t("profile.tweets")}/>
            <Cardtrandy trindname={t("explore.foru_placeName")} trindy={t("rightsidebar.trendy")} tweetnumber="100000k" tweets={t("profile.tweets")}/>
            <Cardtrandy trindname={t("explore.foru_placeName")} trindy={t("rightsidebar.trendy")} tweetnumber="100000k " tweets={t("profile.tweets")}/>
          ...
          <div className="follow d-flex flex-column  card border-0 mt-3 bg-element">
            <h1 style={{fontSize: "20px", fontWeight: "700", padding: "13px 12px", margin: "0"}}>{t("explore.how_follow")}</h1>
            <SuggestionFollow/>
            <Link to="#" className="show_more">{t("rightsidebar.show_more")}</Link>
          </div>
        </div>
