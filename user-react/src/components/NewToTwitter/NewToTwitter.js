                    ...
                    <div className="card-body">
                        <div className="card-text">
                            ...
                            <div className='d-flex flex-column createAccount-button'>
                                ...
                                <h6 className="card-subtitle my-3 text-muted ">Sign up now to get your own personalized timeline!</h6>
                                ...
                                <a href="#!" className='btn btn-outline-dark  px-5 py-2 my-3 rounded-5 col-md-11 col-7'> <b>Create Account</b></a>
