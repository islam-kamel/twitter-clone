...
const twitter = <svg width={32} viewBox="0 0 24 24" aria-label="Twitter" role="img">
    <g>
        <path
    ...
    return (
        <div>
            <TwModal id={"login-modal"} modalStyle={"modal-dialog-scrollable"}>
                <TwModal.Header classes={'text-dark text-center w-100'} title={twitter}/>
                <TwModal.Body>
        ...
        >
            ...
            <Modal.Body className="modal-dialog-scrollable"
                ...
                <div className="d-flex flex-column  login-Form">
                    <h2 className=""><b>Sign in to Twitter</b></h2><br/>
                    <a href="#!" className="btn btn-outline-secondary   py-2 my-3 rounded-5 col-md-4 col-7"><i
                        class="fab fa-google fa-1x "></i> Sign in with Google</a>
                    <a href="#!" className="btn btn-outline-secondary  px-5 py-2 my-3 rounded-5 col-md-4 col-7"><i
                    ...
                    <form className="px-5">
                        <div className="mb-3 col-md-12  col-12 ms-3">
                            ...
                            <input type="email" className="form-control px-5" id="exampleInputEmail1"
                                   aria-describedby="emailHelp"/>
                        </div>
                        <div className="mb-3 col-md-12  col-12 ms-3 ">
                            ...
                            <br/>
                            <a href="#!"
                               className="btn btn-outline-secondary  px-5 py-2 my-3 rounded-5 col-md-12 col-12">Forget
                                Password?</a>
                            <br/>
                            <div className="col-md-10">
                                <p className="my-4">Don't have an account? <a href="#!" className="text-primary-50">Sign
                                    Up</a>
                                </p>
                                <br/>
                            </div>
