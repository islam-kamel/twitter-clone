...
export default function Explore() {
  const handleSearcher = () => {
    document.getElementById("input-bar").addEventListener("blur", () => {
      ...
      serchIcon.style.cssText =
        " background-color:#dad9d9c4; border: 0;color:#797979;";
    ...
    document.getElementById("input-bar").addEventListener("focus", () => {
      var serchIcon = document.getElementById("search-icon");
      serchIcon.style.cssText =
        " background-color:#eff3f4; border: 1px solid #1c88d2;color:#1c88d2;";
      document.getElementById("input-bar").style.backgroundColor =
        "#eff3f4 !important";
    });
  };
        ...
        <div className="row">
          <div id="explore" className=" col-12  border-end p-3">
            ...
            <div id="searchBar" className="t-center col-10">
              <div
                className=" mb-1  justify-content-between align-items-center d-flex "
                id="search-group"
              >
                <div
                ...
                >
                  ...
                  <input
                    type="text"
                    className=" bg-transparent   border border-0 fs-6 "
                    id="input-bar"
                    ...
                    >
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            <div className="d-flex justify-content-center align-items-center ">
                              <button
                                type="button"
                                width="50"
                                className="btn-close fw-4 "
                                data-bs-dismiss="modal"
                                aria-label="Close"
                              ></button>
                              <h5
                                className="modal-title fs-5 fw-4 ms-3"
                          ...
                          <div
                            className="modal-body py-3 d-flex justify-content-between "
                            style={{ height: "500px" }}
                          >
                            <div>
                              ...
                              <p className="" style={{ fontSize: 13 }}>
                                Personalize trends based on your location and
                                who you follow.
                              </p>
                            </div>
            ...
            <div>
              ...
              >
                <ul
                  className="nav nav-pills  mt-2 col-10 w-100 fs-6 fw-5  d-flex justify-content-around align-items-center"
                ...
                >
                  ...
                  <li className="nav-item" role="presentation">
                    <button
                      ...
                      type="button"
                      role="tab"
                      aria-controls="pills-Entertainment-tab"
                      aria-selected="false"
                    >
                      Entertainment
                    </button>
              ...
              <div
                className=" bg-dark-subtle w-100"
                style={{ height: 1 }}
              ></div>
            </div>
            <div className="tab-content show" id="pills-tabContent">
              ...
              <div
                ...
                id="pills-foryou"
                role="tabpanel"
                aria-labelledby="pills-foryou-tab"
                tabindex="0"
              >
                <Trends
                  className="trendss"
                  trendPlace="Trending in Egypt"
                  trendName="أفريقيا يا زمالك"
                  trendTweets="24,2K Tweets"
                ></Trends>
                ...
                <Trends
                  ...
                  trendPlace="Trending in Egypt"
                  trendName="الزمالك#"
                  trendTweets="54,8K Tweets"
                ></Trends>

                <Trends
                  className="trendss"
                  trendPlace="Trending in Egypt"
                  trendName="كاس العالم للأندية#"
                  trendTweets="Trending With كاس العالم "
                ></Trends>
                ...
                <Trends
                  ...
                  trendPlace="Trending in Egypt"
                  trendName="تضامن مصر"
                  trendTweets="25,1K Tweets"
                ></Trends>

                <Trends
                  className="trendss"
                  trendPlace="Trending in Egypt"
                  trendName="الهداف التاريخي"
                  trendTweets="26.0K Tweets"
                ></Trends>
              ...
              >
                <Trends
                  className="trendss"
                  trendPlace="Trending in Entertainment"
                  trendName="Marvel Studios"
                  trendTweets="55.3K Tweets"
                ></Trends>
